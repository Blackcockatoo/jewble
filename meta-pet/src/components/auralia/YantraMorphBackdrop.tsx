...
export const YantraMorphBackdrop: React.FC<YantraMorphBackdropProps> = ({
  ...
  }, [width, height, energy, curiosity, bond]);

  return <canvas ref={canvasRef} className={`absolute inset-0 pointer-events-none mix-blend-screen opacity-70 ${className}`} aria-hidden="true" />;
};
